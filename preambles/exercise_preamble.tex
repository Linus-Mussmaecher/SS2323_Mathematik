...
% and set the language using
%\usepackage[german/english]{babel}

% then use one of this command to print the header (language will be detected automatically)
...
\usepackage{iflang}         % for language-checking ifs
...
\usepackage{titling}
\newcommand{\makeexheader}{
    \begin{doublespace}
        \begin{center}
            \textbf{\Large{\iflanguage{german}{Übungsblatt}{Exercise Sheet} \sheetNumber}}\\
            \textbf{\Large\lecture}\\
            \iflanguage{german}{Abgabe von}{Contributors}: \textbf{\authors}\\
            \today
        \end{center}
        \ifdef {\sumPoints}
        {
            \hfill  \large \iflanguage{german}{Punkte}{Points}: $\boxed{\qquad  /\; \sumPoints}$\\
        }{}
    \end{doublespace}
}
