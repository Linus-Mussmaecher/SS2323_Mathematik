...
\begin{document}
    ...
    Diese kann sich (in der Ebene) auch selbst schneiden.
    Man zeichnet diese Kreuzungen daher so, dass man sehen kann \\
    \blankword{welcher der beiden Stränge oben ist}.\\
