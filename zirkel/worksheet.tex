...
\begin{document}
    ...
    \begin{tabular*}{\textwidth}{L{0.65\textwidth} R{0.35\textwidth}}
        \multirow{4}{*}{\includegraphics[height=2.1cm]{img/unimarke_Vektor_CMYK.eps} \qquad \includegraphics[height=2.1cm]{img/LOGO-wuemax-color-2022.png}} & \textsc{Universität Würzburg}  \\
    ...
    Ein \textbf{Knoten} ist ein Weg im Raum, der sich \blankword{niemals} selbst schneidet.
    ...
    \begin{tabular}{c c c c}
        ...
        \fbox{\phantom{\includegraphics[width=3.5cm]{img/knots0.png}}} \\
        \blankword{Unknoten} &
        \blankword{Kleeblatt} &
        \blankword{Achter} &
        \blankword{Eigener}
    ...
    Man zeichnet einen Knoten immer so, dass man sehen kann,\\
    \blankword{welcher von zwei kreuzenden Stränge oben ist}.\\
    ...
    \begin{center}
        \begin{tabular}{c c c}
            ...
            \fbox{\phantom{\includegraphics[width=3.5cm]{img/eight0.png}}}
    \end{tabular}
    \end{center}
