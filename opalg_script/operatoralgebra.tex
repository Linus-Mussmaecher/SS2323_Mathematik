...
\begin{remark}
	...
	So Cauchy-Schwarz-inequality holds: $|\langle a, b \rangle_\phi| \leq \|a\|_\phi \cdot \|b\|_\phi$ where $\|a\|_\phi \coloneq \langle a, a \rangle_\phi = \phi(a^* a)$ is the semi-norm implied by $\langle \cdot, \cdot \rangle_\phi$.
...
\begin{theorem}
	If $\algebra{A}$ is a $C^*$-algebra nad $a \in \algebra{A}$ is normal with $\algebra{A} \neq 0$ there exists a state $\phi \in S(\algebra{A})$ with $|\phi(a)| = \|a\|$ 
\end{theorem}
...
\begin{proof}
	...
	Then there exists an $\chi \in \Omega(\algebra{B}) = X$ (compact) such that $| \hat{a}(\chi)| = |\chi(a)| = \|\hat{a}\|_\infty = \|a\|$.
