...
\begin{definition}
	If $\algebra{A}$ is any algebra, then $\sigma(a) \coloneq \sigma_{\tilde A}(a)  = \sigma_{\tilde A}(a,0)$.
...
\begin{corollary}~
	\begin{enumerate}
		...
		\item If $\algebra{A}$ is already unital, then $a \in \algebra{A}$, then $\sigma_A(a) = \sigma_{\tilde A}(a)$.
